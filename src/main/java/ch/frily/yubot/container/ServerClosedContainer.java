...
import ch.frily.yubot.interaction.button.btn.AddServeropenRoleBtn;
...
public class ServerClosedContainer extends Container {
    ...
    public ServerClosedContainer(){
        ...
        this.addComponent(ActionRow.of(
                ...
                Button.of(ButtonStyle.LINK, "https://losr.de", "Losr Shop", Emoji.fromCustom("shopping", 1533531377641984030L, false))
        ));
